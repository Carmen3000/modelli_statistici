...
# proseguiamo nella stima di modelli con ordine superiore 2
...
# l'andamento della componente stagionale è più o meno conforme ai dati
...
# stima del trend e della componente stagionale 
# senza la componente di grado 1 del polinomio
modFinale2<-lm(Dati~d1+d2+d3+d4+d5+d6+d7+d8+d9+d10+d11+d12+I(t^2)+I(t^3)-1)
summary(modFinale2)


# plot finale 2
fit_modFinale2<-fitted(modFinale)
